...
$( function() {
    ...
    var formRegistro = {
        ...
        _clearFields : function(frm){
            ...
            formRegistro.filtrosEstablecimientoReasignaClv('#fRol','#fSubRol');
        },
        close : function(idClose){
            var aCloseCW = $(idClose),
                wModalCW = $('#mask'),
                jstrap = new jStrap(),
                msjChangeP = $('#idMessageChangePassE');
            aCloseCW.bind('click',function(){
                jstrap.clearForm({form : '#cClaveCP'});
                msjChangeP.text('').addClass('hide');
            });
            wModalCW.live('click',function(){
                jstrap.clearForm({form : '#cClaveCP'});
                msjChangeP.text('').addClass('hide');
            });
        },
        fMail: function(idMail){
        ...
        filtrosEstablecimientoReasignaClv: function(a,b) {
            var A = $(a), B = $(b);
            if(A.val()==2){
