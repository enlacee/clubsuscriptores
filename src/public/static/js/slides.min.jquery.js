...
return false;});if(option.play){playInterval=setInterval(function(){animate('next',effect);},option.play);elem.data('interval',playInterval);}});};$.fn.slides.option={preload:false,preloadImage:urls.mediaUrl+'/images/loading.gif',container:'slides_container',generateNextPrev:false,next:'next',prev:'prev',pagination:true,generatePagination:true,paginationClass:'pagination-slider',fadeSpeed:350,fadeEasing:'',slideSpeed:350,slideEasing:'',start:1,effect:'slide',crossfade:false,randomize:false,play:0,pause:0,hoverPause:false,autoHeight:false,autoHeightSpeed:350,bigTarget:false,animationStart:function(){},animationComplete:function(){}};$.fn.randomize=function(callback){function randomizeOrder(){return(Math.round(Math.random())-0.5);}
...
$(function(){
        /*slider de promo*/
        $("#promo1Content").slides({
            preload: true,
            preloadImage: urls.mediaUrl+'/images/loading.gif',
            container:'promo-slide',
            paginationClass:'pagination-slider',
            play: 5000,
            pause: 2500,
            hoverPause: true,
	...
	// slider de concursos
	$('#slides-concursos').slides({
		preload: true,
		preloadImage: urls.mediaUrl+'/images/loading.gif',
		container:'slides-container',
		paginationClass:'pagination-slider2',
		play: 5000,
		pause: 2500,
		hoverPause: true,
		animationStart: function(current){
			$('.caption-concursos').animate({
				bottom:-35
			},100);
			if (window.console && console.log) {
				// example return of current slide number
